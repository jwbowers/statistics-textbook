...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, coltitle=black, bottomtitle=1mm, titlerule=0mm, breakable, toprule=.15mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Exploration Goals}, bottomrule=.15mm, arc=.35mm, colframe=quarto-callout-note-color-frame, colback=white, opacitybacktitle=0.6, rightrule=.15mm, leftrule=.75mm]
